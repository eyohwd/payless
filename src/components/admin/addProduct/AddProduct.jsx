...
uploadTask.on('state_changed', 
  ...
  return (
    ...
    <div className={styles.product}>
      <h2>{detectForm(id, "Add New Products", "Edit Product")}</h2>
      <Card cardClass={styles.card}>
        <form onSubmit={detectForm(id, addProduct, editProduct)}>
        <label>Product Name:</label>
        <input type="text" placeholder="Product name" required name="name" 
        value={product.name} onChange={(e) => handleInputChange(e)}/>
        ...
        value={product.price} onChange={(e) => handleInputChange(e)}/>
       ...
       <label>Product Category:</label>
        ...
        <input type="text" placeholder="Product brand" required name="brand" 
